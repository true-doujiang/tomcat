...
public class ModernServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) {
        System.out.println("ModernServlet -- init config=" + config);
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(Thread.currentThread().getName() + " ModernServlet request = " + request);
        System.out.println(Thread.currentThread().getName() + " ModernServlet response = " + response);
        System.out.println(Thread.currentThread().getName() + " ModernServlet PrintWriter = " + out);
