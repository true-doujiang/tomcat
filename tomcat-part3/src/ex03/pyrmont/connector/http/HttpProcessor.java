    ...
    public void process(Socket socket) {
        ...
        try {
            ...
            if (request.getRequestURI().startsWith("/servlet/")) {
            	System.out.println(Thread.currentThread().getName() + " 处理servlet请求    request = " + request);
                System.out.println(Thread.currentThread().getName() + " 处理servlet请求    response = " + response);
            ...
            System.out.println(Thread.currentThread().getName() + " 断开连接 socket: " + socket);
            socket.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
